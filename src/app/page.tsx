    ...
    return (
        <div className="container" style={{ maxWidth: '600px' }}>
            <header style={{
                ...
                <div>
                    <h1 className="title-gradient" style={{ fontSize: '1.8rem', fontWeight: 'bold' }}>Тропы Наследия</h1>
                    <p style={{ color: 'var(--muted)', fontSize: '1rem' }}>Мультимедийный гид по Абхазии</p>
                </div>
                <Link href="/profile" className="icon-badge" style={{ textDecoration: 'none', width: '56px', height: '56px' }}>
                    <span style={{ fontWeight: 'bold', fontSize: '1.1rem' }}>{userData.points}</span>
                </Link>
            </header>
            ...
            <section className="glass-panel" style={{ padding: '1.5rem', marginBottom: '2.5rem' }}>
                ...
                <p style={{ color: 'var(--foreground)', lineHeight: '1.6' }}>
                    Добро пожаловать в интерактивный путеводитель по историческим и природным жемчужинам Абхазии.
                    Исследуйте древние городища, слушайте уникальные аудиогиды и открывайте для себя тайные тропы.
                    Собирайте баллы за посещение мест и изучение истории!
                </p>
            </section>
